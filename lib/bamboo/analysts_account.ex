defmodule Bamboo.AnalystsAccount do
  @moduledoc """
  The AnalystsAccount context.
  """
  ...
  ## Examples
      ...
      %Ecto.Changeset{data: %Analyst{}}

  """
  def change_analyst(%Analyst{} = analyst, attrs \\ %{}) do
    Analyst.changeset(analyst, attrs)
  end
end
